import forwardKernel as forward
import numpy as np

def testPropagation(size, origin, p, maxt, maxr, alpha):
    """
    ...
    for r in range(maxr):
        ...
        sampleRun = forward.propagateFire(size, origin, p, maxt, alpha)
        Mavg += sampleRun[-1,:,:]
    Mavg /= maxr
...
if __name__ == "__main__":
    ...
    maxr = 5000
    alpha = 0.5
    testPropagation([n,n], origin, p, maxt, maxr, alpha)